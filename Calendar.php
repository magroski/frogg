...
class Calendar
{
     ...
     *                      - 'timezone' [default='Etc/UTC'] the timezone of the data sent in this configuration array. All the
     *                      data(from,to,fromHour,toHour) must use the same tstamp.
     ...
     *
     * @throws \Exception
     * @return array containing the free time slots as defined in the config param. Each time slot is an array with the elements "start"
     *               ans "end". The values returned are always on the 'Etc/UTC timezone'
     */
     ...
     *
     * @throws \Exception
     * @return array containing the time slots defined in the config param. Each time slot is an array with the elements "start" ans "end".
     *               The values returned are always on the 'Etc/UTC timezone'
     */
